...
district_contribution <- function(state_arg, data_arg) {
  if (data_arg == "tie") {
...
contribution_graph <- function(data_arg) {
  data <- lapply(swing_states, district_contribution, data_arg) %>%
    bind_rows()
